...
echo "  2) Omni search (all chains: EVM, Solana, Bitcoin, TON)"
...
echo " 11) TON only (The Open Network v4R2)"
echo ""
read -p "Option [1-11, default 3]: " choice
...
case "$choice" in
  ...
  10)
    ...
    ;;
  11)
    ./target/release/crypto-vanity-gen --network ton --min-rarity epic
    ;;
  *)
    ./target/release/crypto-vanity-gen --view
    ;;
